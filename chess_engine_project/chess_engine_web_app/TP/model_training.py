...
from tensorflow.keras.layers import (LSTM, BatchNormalization, Dense, Dropout, Flatten,
                          TimeDistributed, Conv2D, MaxPooling2D, Embedding, Input, Reshape, Activation, GlobalMaxPooling2D, Concatenate)
...
if __name__ == '__main__':
    ...
    model.fit(X_train, y_train, batch_size=128, epochs=50, verbose=1, callbacks=[callback], validation_data=(X_test, y_test), shuffle=True, use_multiprocessing=True, workers=6)
